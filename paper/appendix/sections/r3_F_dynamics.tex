...
The postperiod dynamic functional averages the 15 post-quarter coefficients with predeclared calendar weights.  Its pooled value is $-0.1199$, with interval $[-0.2618,0.0221]$.  Its family-conditioned value is $-0.2074$, with interval $[-0.4216,0.0067]$.  This linear functional is not the nonlinear static grouped-binomial coefficient.  The mapping file reports their paired relationship rather than silently treating them as identical.
