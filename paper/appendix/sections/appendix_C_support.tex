...
Support depends on the statement being estimated. A continuous horse race consumes residual score variation after controls; a tail comparison consumes weighted group membership; a ranking statement consumes pairwise order. Figure~\ref{fig:app-supportbridge} is therefore not a generic data-coverage diagnostic.
