...
\item The common route-share limitation, one-to-many stock, conservation, stable-taxonomy restriction, and changed time/population estimand are stated.  Earlier failed post-2020 and seasonal attempts remain recorded, while coding-stable replacement fits now pass the common numerical certification and are reported explicitly.
