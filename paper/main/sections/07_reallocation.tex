...
\tabnote{Coefficients are relative to Q1 and omitted 2022Q4 under rebuilt labels; lines are pointwise 95-percent occupation wild-score intervals.  Appendix~\ref{app:dynamics} reports simultaneous bands and the Q2--Q5 system.  The conditioned model gives each SOC2 family its own young-relative monthly path.}
\end{figure}
