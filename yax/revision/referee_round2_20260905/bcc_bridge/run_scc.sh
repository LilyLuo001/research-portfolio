...
#$ -l mem_per_core=16G
#$ -j y
#$ -o /projectnb/econdept/qluo/yax-referee-revision-20260905/yax/revision/referee_round2_20260905/bcc_bridge/results/scc_execution.log
...
/usr3/graduate/qluo/portfolio/.venv/bin/python \
  yax/revision/referee_round2_20260905/bcc_bridge/run_bcc_grouping_bridge.py \
  ...
  --output-dir yax/revision/referee_round2_20260905/bcc_bridge/results
