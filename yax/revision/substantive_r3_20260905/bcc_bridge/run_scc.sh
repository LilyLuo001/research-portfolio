...
#$ -l mem_per_core=8G
#$ -pe omp 4
#$ -o /project/econdept/qluo/yax-substantive-revision-20260905/logs/bcc_bridge.log
...
OUTPUT_ROOT="$COMPUTE_ROOT/results/bcc_bridge"
...
"$PYTHON_BIN" \
  yax/revision/substantive_r3_20260905/bcc_bridge/run_bcc_bridge.py \
...
"$PYTHON_BIN" \
  yax/revision/substantive_r3_20260905/bcc_bridge/selfcheck.py \
  --output-dir "$OUTPUT_ROOT"
