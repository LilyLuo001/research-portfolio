...
"$PYTHON_BIN" \
  yax/revision/substantive_r3_20260905/characteristics/run_characteristic_conditioning.py \
...
"$PYTHON_BIN" \
  yax/revision/substantive_r3_20260905/characteristics/selfcheck.py \
