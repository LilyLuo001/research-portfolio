...
- **下一轮准备完成、尚未执行：[FOMC消息到达与跨市场响应prompt](20260922_fomc_information_arrival/NEXT_EXECUTION_PROMPT.md)**。在已完成普通日24日外部复现后，建议2023/2024全部16次例行FOMC声明加固定同钟点对照，比较ES/SPY/23股实际响应和控制ES报价/成交后的条件增量。采用Sol/medium主执行、Terra/medium工程、末端Sol/high有限复核；本轮仅写计划，未连接SCC、购数或启动新实证。选择理由与解释边界见[判断](20260922_fomc_information_arrival/ASSESSMENT.md)。
