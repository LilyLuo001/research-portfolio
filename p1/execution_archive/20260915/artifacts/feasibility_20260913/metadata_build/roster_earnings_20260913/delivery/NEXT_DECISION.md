...
records only: no economic-event de-duplication, timezone rule, exchange
calendar/session classification, quote coverage, or response outcome has been
created.
...
margins, H3, or causal interpretation. In parallel, final new-clock membership
still needs package-specific announcement evidence, pre-announcement holdings,
and denominator/corporate-action evidence listed row-by-row in
