...
Plan: **`docs/MacroEvent_Chapter_Plan_v2_4.md` (v2.4 FINAL, 2026-08-19)**. Prior versions
kept as superseded records. **No further plan revision** — remaining work is empirical.
