...
> ## ⚠️ 读这一段再往下读(2026-09-03)
>
> 本文件是**执行手册**:元规则、CONTEXT PACK、T0–T12 的任务 prompt、§5 契约、
> §6 节奏。**只在"流程"上有效。**
>
> 它写于 **2026-07-10,对应 v1.0 的研究设计**。凡是涉及**研究实质**的地方——
> 结果变量、假设、T3/T5 到底估什么、脊柱优先级——**一律以
> `docs/基金转换实验_博士研究计划.md` 为准**,本文件在这些地方已过时。
>
> 具体地:主结果是**带符号 `CAR^h` 对 h 的响应曲线 β_h**(股票 × 盈余事件),
> 不是 v1.0 的市场质量(波动率/流动性)结果;逐变量口径见
> `p1/t3_spec/变量规格书.md` 的 D-T3-xx 表。
>
> **不要按本文件的研究实质去执行,也不要去找 P1 的补丁备忘录——它们已删除。**
